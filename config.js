...
const CONFIG = {
    ...
    OPCIONES_PRINCIPALES: {
        ...
        2: { texto: "🏙️ Buscar por barrio", filtro: "barrio", icon: "📍" },
        3: { texto: "💰 Buscar por operación (venta/alquiler)", filtro: "operacion", icon: "💵" },
        4: { texto: "📏 Buscar por cantidad de ambientes", filtro: "ambientes", icon: "🛏️" },
    ...
    MENSAJES: {
        BIENVENIDA: "¡Hola! Soy tu asistente virtual de **Dante Propiedades**. Te ayudo a encontrar la propiedad ideal.",
        ...
        RESULTADOS: "✅ Encontré **{count}** propiedad(es) para tu búsqueda:",
